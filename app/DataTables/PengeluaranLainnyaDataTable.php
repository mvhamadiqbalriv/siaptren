...
class PengeluaranLainnyaDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Keuangan\PengeluaranLainnya $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PengeluaranLainnya $model)
    {
        return $model::from('pengeluaran as p')
    ...
    {
        return $this->builder()
            ->setTableId('pengeluaranlainnya-table')
    ...
    {
        return 'PengeluaranLainnya_' . date('YmdHis');
    }
}
