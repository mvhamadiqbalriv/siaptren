                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted font-14 mt-2">
                                            Hasil pemeriksaaan akan dikirim ke alamat email <b>{{ $santri->email }}</b>. Hasil pemeriksaaan yang kami kirimkan harus dicetak dan dibawa bersama formulir pendaftaran sebagai bukti pendaftaran. 
                                        </p>

                                        <a href="{{ url('pendaftaran/download-formulir').'/'.encrypt($santri->kode_santri) }}" target="_blank" class="btn btn-md btn-block btn-gradient waves-effect waves-light mt-3">Download Formulir</a>
