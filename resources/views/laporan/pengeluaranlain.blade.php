            ...
            <div class="card-box">
                ...
                @if (request('tanggal_awal') and request('tanggal_akhir'))
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('pengeluaran-lain.cetak') }}?tanggal_awal={{ request('tanggal_awal') }}&tanggal_akhir={{ request('tanggal_akhir') }}" target="_blank" class="btn btn-primary waves-effect">Cetak Laporan</a>
                        </div>
                    </div>
                    @else
                    <div class="alert alert-danger">
