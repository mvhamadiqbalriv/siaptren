...
@push('js')
    ...
    <script>
        ...
        var pemasukanJs = function(){
            const indexURL = `{{ route('eksternal.index') }}`,
                tableID = 'pemasukaneksternal-table'
            ...
            $('.add').on('click', function(){
                ...
                handleAction(`{{ route('eksternal.create') }}`, initFunction)
            })

            $('#pemasukaneksternal-table').on('click', '.batal', function(){
                fixBootstrapModal()
                Swal.fire({
                    ...
                    if (res.value) {
                        $.ajax({
                            url: `{{ url('keuangan/pemasukan/eksternal/batal') }}/${id}`,
                            method: 'put',
                            data: {
